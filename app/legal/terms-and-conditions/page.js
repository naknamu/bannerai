    ...
    <div className="container">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to BannerAI.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to BannerAI, accessible from{" "}
            <a
              href="https://www.bannerai.cc"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://www.bannerai.cc
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>
          ...
          <a
            href="https://www.bannerai.cc/contact"
            rel="external nofollow noopener"
            target="_blank"
          >
            https://www.bannerai.cc/contact
          </a>
        </li>
      </ul>
    </div>
